...
function calcNetworkBalance(db) {
    ...
    const avgBandwidthPerDevice = endpoints.length > 0 ? wanTotalDown / endpoints.length : 0;
    ...
    return {
        ...
        endpointCount: endpoints.length, infraCount: infra.length,
